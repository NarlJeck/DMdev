...
import multithreading.entity.RaceMage;
 ...
 *
 * Кристаллы растут на другой планете с рандомной скоростью от 2 до 5 рандомных кристаллов
 * в сутки (может быть 1 красный и 2 белых, а может и вовсе все 4 кристалла красного цвета).
 *
...
public class Competition {
    ...
    public static void main(String[] args) throws InterruptedException {
        RaceMage fireMage = new RaceMage("FireMage");
        RaceMage airMage = new RaceMage("AirMage");
